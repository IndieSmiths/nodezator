...
def get_expanded_body_surface(self):
    ...
    ### if there's a keyword-variable parameter in the node, blit the keyword
    ### key icon beside each keyword entry or subparameter unpacking icon for
    ### that parameter (if there's any subparameter);
    ###
    ...
    ### widgets among other entry widgets the node might be using
